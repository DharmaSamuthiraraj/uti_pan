...
var specificid1 = specificid;
	...
	{ $("#namepapplicantblank,#namepapplicantblank1").show();
	 document.getElementById("first").value = document.getElementById("first").value.toUpperCase(); 
	  document.getElementById("print_firstname").value = document.getElementById("first").value.toUpperCase()+ ' '+document.getElementById("middle").value.toUpperCase();
	  
	   var names = document.getElementById("first").value.toUpperCase()+' '+document.getElementById("middle").value.toUpperCase() +' '+document.getElementById("last").value.toUpperCase();
	...
	if(specificid1 == 'middle')
	{ 
		$("#namepapplicantblank,#namepapplicantblank1").show();
	    document.getElementById("middle").value = document.getElementById("middle").value.toUpperCase();
	...
	$("#namepapplicant, #namepapplicant1").css('text-decoration', 'underline'); 
	 ...
	 document.getElementById("print_lastname").value = document.getElementById("last").value.toUpperCase();
