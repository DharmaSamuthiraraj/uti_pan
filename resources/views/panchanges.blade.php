...
@section('content')
    ...
    <section class="header-panel">
      <div class="block-header-wrapper">
        <div class="container">
          <div class="row">
            <h2 class="title">Change/Correction in PAN Card</h2>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="free-trail-form">
                    <section class="common-form">
                      ...
                      <div class="form-group">
                        <label class="control-label col-xs-3">Applicant Name <span class="red">*</span> <a href="#" class="tooltip">
    Tooltip
    <span>
                  ...
                  <div class="free-trail-form">
                    <section class="common-form">
                      ...
                      <div class="col-xs-6">
                        ...
                        <div class="apply_tooltip"> <i class="fa fa-exclamation" aria-hidden="true"></i>
                          <div class="tooltip">Resident Address is Manditaory for Individuals</div>
                        </div>
                      </div>
                      <div class="col-xs-6">
                        <h4>Office Address (Optional) </h4>
                        <div class="apply_tooltip"> <i class="fa fa-exclamation" aria-hidden="true"></i>
                          <div class="tooltip">If Address of Comunication is selected as office then proof of Office Address along with Proof of Residential Address is Mandatory</div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-xs-3">Flat/Room/Door/Block No.</label>
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="flat_no" placeholder="">
                        </div>
                        <label class="control-label col-xs-3">Name of Office</label>
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="Name of Office" placeholder="">
                        </div>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="free-trail-form">
                    <section class="common-form">
                      ...
                      <div class="row col-xs-12">
                        <h4>
                          <input type="checkbox" value="" style="margin-right:10px;" checked>
                          Representative Assessee is applicable </h4>
                        <div class="apply_tooltip"> <i class="fa fa-exclamation" aria-hidden="true"></i>
                          <div class="tooltip">This Field is Mandatory If applicant is Minor, deceased, Idiot, lunatic or Mentally Retarded.</div>
                        </div>
                      </div>
                      <br>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="Name of Office" placeholder="First Name">
                        </div>
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="Name of Office" placeholder="Middle Name">
                        </div>
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="Name of Office" placeholder="Last Name">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-xs-3">Flat/Room/Door/Block No. *</label>
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-xs-3">Country</label>
                        <div class="col-xs-3">
                          <input type="text" class="form-control" id="Name of Office" placeholder="India" readonly="readonly">
                        </div>
                      </div>
                    </section>
                  </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="free-trail-form">
                    <section class="common-form">
                     ...
                     <p> I have enclosed ________________________ as proof of identity, ________________________ as proof of address and ________________________ as proof of date of birth.</p>
                     <p>I ________________________, the applicant, in the capacity of do hereby declare that what is stated above is true to the best of my information and belief.</p>
<p>Date: 26-Sep-2016 City of residence ________________________</p>
